class SuraModel{
  ...
  static List<SuraModel> suraList=[]; ///114 esm 3rby, 114 english,114 numverses,114 file name

  SuraModel({required this.suraArabicName,required this.suraEnglishName,
